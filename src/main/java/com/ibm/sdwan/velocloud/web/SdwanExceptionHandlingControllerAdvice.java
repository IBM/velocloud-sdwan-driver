...
import com.ibm.sdwan.velocloud.model.web.ErrorInfo;
...
/**
 * Handles the conversion of Exceptions thrown by Sdwan Rest API calls
 */
...
public class SdwanExceptionHandlingControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    protected ErrorInfo handleHttpMessageConversionException(HttpServletRequest req,
            HttpMessageConversionException cause) {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    protected ErrorInfo handleHttpMessageNotReadableException(HttpServletRequest req,
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    protected ErrorInfo handleMissingServletRequestParameterException(HttpServletRequest req,
            MissingServletRequestParameterException cause) {
    ...
    @ResponseBody
    protected ErrorInfo handleHttpMediaTypeNotSupportedException(HttpServletRequest req,
            HttpMediaTypeNotSupportedException cause) {
        return defaultHandle("Invalid content provided to request", req, cause);
    }
    ...
    @ResponseStatus(HttpStatus.UNSUPPORTED_MEDIA_TYPE)
    @ResponseBody
    protected ErrorInfo handleHttpMediaTypeNotAcceptableException(HttpServletRequest req,
            HttpMediaTypeNotAcceptableException cause) {
        return defaultHandle("Invalid content provided to request", req, cause);
    }
    ...
    @ResponseBody
    protected ErrorInfo handleHttpRequestMethodNotSupportedException(HttpServletRequest req,
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    protected ErrorInfo handleIllegalArgumentException(HttpServletRequest req, IllegalArgumentException cause) {
        return defaultHandle("LifeCycle is not yet implemented", req, cause);
    }

    @ExceptionHandler(ThreadInterruptedException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    protected ErrorInfo handleThreadInterruptedException(HttpServletRequest req, ThreadInterruptedException cause) {
        return defaultHandle("Thread interrupted during sleep", req, cause);
    }
